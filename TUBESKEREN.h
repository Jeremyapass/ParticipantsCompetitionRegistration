...
void deletePeserta(list1 &L,adr1 &P, string PESER);//BENER //HASSSAN
...
adr1 findPeserta(list1 L, string nama);//BENER //HASSSAN
adr1 findPeserta2(list1 L, string nama);//BENER

//adr1 findPeserta3(list1 L, string lomba);

void moveChild(list1 &L, adr_child q,List_child Lc);//BENER //HASSAN
void gantilomba(list1 &Lp,adr1 &p, List_child L, string tl, string nama);//BENER //HASSAN
void deleteChild(List_child &L,  list1 &LP, string R);//BENER  //HASSSAN
